...
public class CardPickerDialog extends DialogFragment implements View.OnClickListener {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mCards[0] = (ImageView) view.findViewById(R.id.theme_green_light);
        ...
        mCards[4] = (ImageView) view.findViewById(R.id.theme_pink);
    ...
    private void setImageButtons(int currentTheme) {
        mCards[0].setSelected(currentTheme == ThemeHelper.CARD_WAN);
        ...
        mCards[4].setSelected(currentTheme == ThemeHelper.CARD_PINK);
